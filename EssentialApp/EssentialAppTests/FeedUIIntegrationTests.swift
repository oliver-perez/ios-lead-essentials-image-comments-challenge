...
final class FeedUIIntegrationTests: XCTestCase {
	...
	private func makeSUT(file: StaticString = #filePath, line: UInt = #line) -> (sut: FeedViewController, loader: LoaderSpy) {
		...
		let sut = FeedUIComposer.feedComposedWith(feedLoader: loader.loadPublisher, imageLoader: loader.loadImageDataPublisher, navigationAdapter: NavigationAdapter(feedImageCommentsCoordinator: FeedImageCommentsCoordinator(navigationController: UINavigationController(), httpClient: HTTPClientStub.offline)))
